            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    for (Map.Entry<Integer, Food> entry : ManagerPayment.foodsOrder.entrySet()) {
                        ...
                        model.addRow(new Object[]{String.valueOf(f1.getId()), f1.getName(), formatter.format(f1.getUnitPrice()), f1.getOrderQuantity(), formatter.format(f1.getUnitPrice() * f1.getOrderQuantity()), ""});
                    }
