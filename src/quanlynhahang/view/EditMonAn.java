...
//        Tittle
        ...
        title.setBounds(320, 0, 420, 50);
        title.setFont(new Font("Serif", Font.PLAIN, 28));

//      Hàng tìm món ăn
        JLabel lblTimKiem = new JLabel();
        lblTimKiem.setText("Tìm món ăn :");
        lblTimKiem.setBounds(230, 55, 150, 60);
        lblTimKiem.setFont(new Font("Serif", Font.PLAIN, 24));
        JTextField txtTimKiem = new JTextField();
        txtTimKiem.setBounds(400, 60, 200, 40);
        JButton btnTimKiem = new JButton();
        btnTimKiem.setText("Tìm kiếm");
        btnTimKiem.setBounds(630, 60, 130, 40);
...
////       Button Cập nhật
        ...
        btnUpdate.setBounds(620, 276, 120, 50);
